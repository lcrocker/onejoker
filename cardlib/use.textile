...
C and C++ programs need only include the single header file @ojcardlib.h@, and link against the library. Further details of the functions available are in the ["C API":/onejoker/cardlib/capi.html] and ["C++ API":/onejoker/cardlib/cppapi.html] documents. An example in C:
