...
Download and unpack the source from this ["zipfile":http://github.com/lcrocker/ojrandlib/archive/master.zip] or use git:

{% highlight bash %}
git clone http://github.com/lcrocker/ojrandlib
{% endhighlight %}

From the root of the tree you just installed, @make@ should now build everything including the basic tests, putting everything into the @build@ directory and running the tests. A more comprehensive test of the RNGs can be built with @make randtest@.
...
This should now build everything including the basic tests, putting everything into the @build@ directory and running the tests. A more comprehensive test of the RNGs can be built with @make -f Makefile.mingw randtest@.
