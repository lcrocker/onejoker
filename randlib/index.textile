...
That's just a taste. To see everything that RandLib does, check out the ["documentation":/randlib/use.html].
...
For more information about developing with RandLib, see the ["development":/randlib/devel.html] documentation.
